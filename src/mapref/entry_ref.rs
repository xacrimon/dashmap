...
impl<'a, 'q, K: Eq + Hash, Q: ?Sized, V> EntryRef<'a, 'q, K, Q, V> {
...
mod tests {
    ...
    #[test]
    fn test_str_insert_into_vacant() {
    ...
    #[test]
    fn test_str_insert_into_occupied() {
        let map: DashMap<String, u32> = DashMap::new();

        map.insert("1".to_owned(), 1000);
    ...
    #[test]
    fn test_str_insert_entry_into_vacant() {
        let map: DashMap<String, u32> = DashMap::new();
    ...
    #[test]
    fn test_str_insert_entry_into_occupied() {
        let map: DashMap<String, u32> = DashMap::new();
